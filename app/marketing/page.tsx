            ...
            {marketingData?.strongVerticalsInsights && marketingData.strongVerticalsInsights.length > 0 ? (
              marketingData.strongVerticalsInsights.map((item, index) => (
                ...
                >
                  ...
                  <div className="mt-3">
                    <button
                      onClick={() => handleOpenLinkedInPreview(item.insight, `Strong Verticals - ${item.industry}`)}
            ...
            {marketingData?.weakVerticalsOpportunities && marketingData.weakVerticalsOpportunities.length > 0 ? (
              marketingData.weakVerticalsOpportunities.map((item, index) => (
                ...
                >
                  ...
                  <div className="mt-3">
                    <button
                      onClick={() => handleOpenLinkedInPreview(item.opportunity, `Weak Verticals - ${item.industry}`)}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-700 dark:text-blue-300 bg-white dark:bg-gray-800 border border-blue-300 dark:border-blue-700 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
          ...
          {marketingData?.marketingRecommendations && marketingData.marketingRecommendations.length > 0 ? (
            marketingData.marketingRecommendations.map((recommendation, index) => (
              <div key={index} className="p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-900">
                ...
                <div className="mt-3">
                  <button
                    onClick={() => handleOpenLinkedInPreview(recommendation, "Strategic Recommendations")}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-700 dark:text-blue-300 bg-white dark:bg-gray-800 border border-blue-300 dark:border-blue-700 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
